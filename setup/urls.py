...
"""
Rotas que vão pegar a classe o viewset dessa classe e um nome base.
Os paths vão possuir os nomes dos dados e caso seja de matriculas vai possuir na url o id (pk) dessa matricula.
"""
